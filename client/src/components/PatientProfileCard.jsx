                            ...
                            <div className="flex-none w-auto max-w-full px-3 my-auto">
                                <div className="h-full">
                                    <h5 className="mb-1 dark:text-white uppercase">
                                        {patient.primernombre} {patient.segundonombre} {patient.primerapellido} {patient.segundoapellido}
                                    </h5>
                                    ...
                                    <p className="mb-0 text-sm leading-normal dark:text-white dark:opacity-60">
                                        <strong className="text-sm leading-normal text-slate-700 dark:text-white">Historial Medico:</strong> &nbsp; {patient.historialmedico}
                                    </p>
                                    <p className="mb-0 text-sm leading-normal dark:text-white dark:opacity-60">
                                        <strong className="text-sm leading-normal text-slate-700 dark:text-white">Medicamentos:</strong> &nbsp; {patient.medicamento}
                                    </p>
                                    <hr className="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent"></hr>
                                </div>
                            </div>
                            <div className="flex-auto p-3">
                                <ul className="flex flex-col pl-0 mb-0 rounded-lg">
                                    <li className="relative block px-4 py-2 pt-0 pl-0 text-sm leading-normal border-0 rounded-t-lg">
                                        <strong className="text-slate-700 dark:text-white">Identificacion:</strong> &nbsp; {identificationType} - {patient.identificacion}
                                    </li>
                                    <li className="relative block px-4 py-2 pl-0 text-sm leading-normal border-0 border-t-0">
                                        <strong className="text-slate-700 dark:text-white">Fecha Nacimiento:</strong> &nbsp; {dayjs(patient.fechanacimiento).utc().format("DD/MM/YYYY")}
                                    </li>
                                    <li className="relative block px-4 py-2 pl-0 text-sm leading-normal border-0 border-t-0">
                                        <strong className="text-slate-700 dark:text-white">Telefono:</strong> &nbsp; {patient.telefono}
                                    </li>
                                    <li className="relative block px-4 py-2 pl-0 text-sm leading-normal border-0 border-t-0">
                                        <strong className="text-slate-700 dark:text-white">Correo:</strong> &nbsp; {patient.email}
                                    </li>
                                    <li className="relative block px-4 py-2 pl-0 text-sm leading-normal border-0 border-t-0">
                                        <strong className="text-slate-700 dark:text-white">Direccion:</strong> &nbsp; {patient.direccion}
                                    </li>
                                    <li className="relative block px-4 py-2 pl-0 text-sm leading-normal border-0 border-t-0">
                                        <strong className="text-slate-700 dark:text-white">Datos de Emergencia:</strong> &nbsp; {patient.emergencianombre} - {patient.emergenciatelefono}
                                    </li>
                                </ul>
                                <Link
