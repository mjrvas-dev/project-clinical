            ...
            <div className="flex-auto p-4">
                <div class="flex">
                    <div class="my-auto ml-2">
                        <h6 class="mb-0 dark:text-white uppercase">{task.title}</h6>
                        <p class="mb-0 text-xs leading-tight dark:text-white/60">Fecha {dayjs(task.date).utc().format("DD/MM/YYYY")}</p>
                    </div>
                </div>
                <p class="mt-4 dark:text-white/60"> {task.description}</p>
                {/* <p class="mb-0 dark:text-white/60"><b>Fecha: </b>{dayjs(task.date).utc().format("DD/MM/YYYY")}</p> */}
